	...
	<script>
		$(function () {
			$("#username").blur(function () {
				...
				$.get("UserSvl?reqType=checkuName&username="+uName,function (date,status) {
				    if (date == "true") {
				        $("#username_check").text("用户名重复！");
						$("#username").focus();
						$("#username").select();
					}else {
                        $("#username_check").text("");
			...
			<table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3">
				<tr>
					...
					<td width="89%">
						...
						<span id="username_check" style="color:#FF0000"> </span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td align="left">
						<input name="Submit" type="submit" value="" class="us_Submit_reg"/>${info}
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
